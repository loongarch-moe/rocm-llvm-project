...
; RUN: llc -O0 -stop-after=regallocfast,1 < %s | FileCheck --check-prefixes=COMMON,AFTER-RA %s
...
; AFTER-RA-NOT: DBG_
; AFTER-RA: DBG_DEF ![[ENTRY_LIFETIME_VAR_I]], renamable $vgpr0
; AFTER-RA-NOT: DBG_
...
; AFTER-PEI-NOT: DBG_
; AFTER-PEI: DBG_DEF ![[ENTRY_LIFETIME_VAR_I]], renamable $vgpr0
; AFTER-PEI-NOT: DBG_
...
; AFTER-LDV-NOT: DBG_
; AFTER-LDV: DBG_DEF ![[ENTRY_LIFETIME_VAR_I]], renamable $vgpr0
; AFTER-LDV-NOT: DBG_
